...
class CreateMysqlDatabase extends Command
{
    ...
    public function handle()
    {
        ...
        $this->createDatabase(
            config('database.connections.mysql_test.database'),
            config('database.connections.mysql_test.username'),
            config('database.connections.mysql_test.password'),
            $forceCreateDatabase
        );
    }
